...
//
	...
	|| (HASH_PREDEF_PLAT_WINDOWS_SDK_VERSION >= 9200)
...
//
// If HASH_PREDEF_PLAT_WINDOWS_UWP is not available, none of the other
// HASH_PREDEF_PLAT_WINDOWS_* are either except for
// HASH_PREDEF_PLAT_WINDOWS_DESKTOP which is available for backwards
// compatibility.
//
...
//
// If HASH_PREDEF_PLAT_WINDOWS_UWP is available, and the SDK supports a
// particular family, and if WINAPI_FAMILY is set to it, then it and only it
// should be available.
//
