...
* A unique HASH_PREDEF_VERSION_NUMBER(major,minor,patch) macro to specify version
...
* A compiler identification macro, suitable for use in `#if`/`#elif` directives,
  ...
  be defined, in terms of HASH_PREDEF_VERSION_NUMBER, to carry the exact compiler
...
in the code; the definition of `HASH_PREDEF_VERSION_NUMBER`.
...
* `HASH_PREDEF_ARCH_` for system/CPU architecture one is compiling for.
* `HASH_PREDEF_COMP_` for the compiler one is using.
* `HASH_PREDEF_LANG_` for language standards one is compiling against.
* `HASH_PREDEF_LIB_C_` and `HASH_PREDEF_LIB_STD_` for the C and {CPP} standard library
  in use.
* `HASH_PREDEF_OS_` for the operating system we are compiling to.
* `HASH_PREDEF_PLAT_` for platforms on top of operating system or compilers.
* `HASH_PREDEF_ENDIAN_` for endianness of the os and architecture combination.
* `HASH_PREDEF_HW_` for hardware specific features.
* `HASH_PREDEF_HW_SIMD` for SIMD (Single Instruction Multiple Data) detection.
...
by comparing against the `HASH_PREDEF_VERSION_NUMBER` macro. For example, to make
...
----
#if HASH_PREDEF_ABC
  #define HASH_PREDEF_ABC_AVAILABLE
#endif
----
...
detection. For example MSVC will set `HASH_PREDEF_COMP_MSVC_EMULATED` but not set `HASH_PREDEF_COMP_MSVC`, and it will also set `HASH_PREDEF_COMP_MSVC_AVAILABLE`.

=== Using the `HASH_PREDEF_VERSION_NUMBER` macro

All the predefs are defined to be a use of the `HASH_PREDEF_VERSION_NUMBER` macro.
...
Only constant value arithmetic is used in the definition of the `HASH_PREDEF_VERSION_NUMBER`
...
[source]
----
#define MY_APPLICATION_VERSION_NUMBER HASH_PREDEF_VERSION_NUMBER(2,0xA,015)
----
...
[source]
----
#define MY_APPLICATION_VERSION_NUMBER HASH_PREDEF_VERSION_NUMBER(2,10,13)
----
...
* The predef must, by default, be defined as `HASH_PREDEF_VERSION_NUMBER_NOT_AVAILABLE`.
* The predef must be redefined to a non-zero value once detected.
* The predef must, by default, be defined to `HASH_PREDEF_VERSION_NUMBER_AVAILABLE`
...
#ifndef HASH_PREDEF_category_tag_H
#define HASH_PREDEF_category_tag_H
----
...
[source]
----
#include <predef/CATEGORY_TAG/DEPENDENCY.h>
----
...
----
/*`
[heading `HASH_PREDEF_category_tag`]

Documentation about what is detected.
*/

#define HASH_PREDEF_category_tag HASH_PREDEF_VERSION_NUMBER_NOT_AVAILABLE
----
...
the overall check is to "`#undef HASH_PREDEF_category_tag`" which undefines
the zero-value default. The rest is up to the you how to do the checks
for defining the version. But at minimum it must
"`#define HASH_PREDEF_category_tag HASH_PREDEF_VERSION_NUMBER_AVAILABLE`" as the fallback
to minimally indicate that the predef was detected:

[source]
----
#if (condition_a)
#   undef HASH_PREDEF_category_tag
#   if (condition_b)
#        define HASH_PREDEF_category_tag HASH_PREDEF_VERSION_NUMBER(major,minor,patch)
#    else
#        define HASH_PREDEF_category_tag HASH_PREDEF_VERSION_NUMBER_AVAILABLE
#    endif
#endif
----
...
[source]
----
#if HASH_PREDEF_category_tag
#   define HASH_PREDEF_category_tag_AVAILABLE
#endif
----
...
[source]
----
#define HASH_PREDEF_category_tag_NAME "Name"
----
...
HASH_PREDEF_DECLARE_TEST(HASH_PREDEF_category_tag,HASH_PREDEF_category_tag_NAME)
----
...
`HASH_PREDEF_DETAIL_COMP_DETECTED`, `HASH_PREDEF_DEFAIL_OS_DETECTED`, and
`HASH_PREDEF_DETAIL_PLAT_DETECTED` respectively when the predef is first
...
[source]
----
#if !HASH_PREDEF_DETAIL_category_DETECTED && (condition_a)
#   undef HASH_PREDEF_category_tag
#   if (condition_b)
#        define HASH_PREDEF_category_tag HASH_PREDEF_VERSION_NUMBER(major,minor,patch)
#    else
#        define HASH_PREDEF_category_tag HASH_PREDEF_VERSION_NUMBER(0,0,1)
#    endif
#endif
----
...
#if HASH_PREDEF_category_tag
#   define HASH_PREDEF_category_tag_AVAILABLE
#   include <predef/detail/CATEGORY_detected.h>
#endif
----
...
define either the base compiler predef `HASH_PREDEF_COMP_compiler` or the alternate
`HASH_PREDEF_COMP_compiler_EMULATED` predef.
...
#if (condition_a)
#   if (condition_b)
#        define HASH_PREDEF_COMP_tag_DETECTION HASH_PREDEF_VERSION_NUMBER(major,minor,patch)
#    else
#        define HASH_PREDEF_COMP_tag_DETECTION HASH_PREDEF_VERSION_NUMBER_AVAILABLE
#    endif
#endif
----
...
[source]
----
#ifdef HASH_PREDEF_COMP_tag_DETECTION
#   if defined(HASH_PREDEF_DETAIL_COMP_DETECTED)
#       define HASH_PREDEF_COMP_tag_EMULATED HASH_PREDEF_COMP_tag_DETECTION
#   else
#       undef HASH_PREDEF_COMP_tag
#       define HASH_PREDEF_COMP_tag HASH_PREDEF_COMP_tag_DETECTION
#   endif
#   define HASH_PREDEF_category_tag_AVAILABLE
...
[source]
----
#define HASH_PREDEF_COMP_EDG HASH_PREDEF_MAKE_N_N_N(__EDG_VERSION__)
----
...
=== `HASH_PREDEF_ARCH` architecture macros
include::../include/predef/architecture/alpha.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/arm.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/blackfin.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/convex.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/ia64.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/m68k.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/mips.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/parisc.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/ppc.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/ptx.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/pyramid.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/riscv.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/rs6k.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/sparc.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/superh.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/sys370.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/sys390.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/x86.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/z.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/x86/32.h[leveloffset=3,tag=reference]
include::../include/predef/architecture/x86/64.h[leveloffset=3,tag=reference]

=== `HASH_PREDEF_COMP` compiler macros
include::../include/predef/compiler/borland.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/clang.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/comeau.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/compaq.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/diab.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/digitalmars.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/dignus.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/edg.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/ekopath.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/gcc.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/gcc_xml.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/greenhills.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/hp_acc.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/iar.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/ibm.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/intel.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/kai.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/llvm.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/metaware.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/metrowerks.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/microtec.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/mpw.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/nvcc.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/palm.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/pgi.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/sgi_mipspro.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/sunpro.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/tendra.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/visualc.h[leveloffset=3,tag=reference]
include::../include/predef/compiler/watcom.h[leveloffset=3,tag=reference]

=== `HASH_PREDEF_LANG` language standards macros
include::../include/predef/language/cuda.h[leveloffset=3,tag=reference]
include::../include/predef/language/objc.h[leveloffset=3,tag=reference]
include::../include/predef/language/stdc.h[leveloffset=3,tag=reference]
include::../include/predef/language/stdcpp.h[leveloffset=3,tag=reference]

=== `HASH_PREDEF_LIB` library macros
include::../include/predef/library/c/_prefix.h[leveloffset=3,tag=reference]
include::../include/predef/library/c/cloudabi.h[leveloffset=3,tag=reference]
include::../include/predef/library/c/gnu.h[leveloffset=3,tag=reference]
include::../include/predef/library/c/uc.h[leveloffset=3,tag=reference]
include::../include/predef/library/c/vms.h[leveloffset=3,tag=reference]
include::../include/predef/library/c/zos.h[leveloffset=3,tag=reference]
include::../include/predef/library/std/_prefix.h[leveloffset=3,tag=reference]
include::../include/predef/library/std/cxx.h[leveloffset=3,tag=reference]
include::../include/predef/library/std/dinkumware.h[leveloffset=3,tag=reference]
include::../include/predef/library/std/libcomo.h[leveloffset=3,tag=reference]
include::../include/predef/library/std/modena.h[leveloffset=3,tag=reference]
include::../include/predef/library/std/msl.h[leveloffset=3,tag=reference]
include::../include/predef/library/std/roguewave.h[leveloffset=3,tag=reference]
include::../include/predef/library/std/sgi.h[leveloffset=3,tag=reference]
include::../include/predef/library/std/stdcpp3.h[leveloffset=3,tag=reference]
include::../include/predef/library/std/stlport.h[leveloffset=3,tag=reference]
include::../include/predef/library/std/vacpp.h[leveloffset=3,tag=reference]

=== `HASH_PREDEF_OS` operating system macros
include::../include/predef/os/aix.h[leveloffset=3,tag=reference]
include::../include/predef/os/amigaos.h[leveloffset=3,tag=reference]
include::../include/predef/os/android.h[leveloffset=3,tag=reference]
include::../include/predef/os/beos.h[leveloffset=3,tag=reference]
include::../include/predef/os/bsd.h[leveloffset=3,tag=reference]
include::../include/predef/os/cygwin.h[leveloffset=3,tag=reference]
include::../include/predef/os/haiku.h[leveloffset=3,tag=reference]
include::../include/predef/os/hpux.h[leveloffset=3,tag=reference]
include::../include/predef/os/ios.h[leveloffset=3,tag=reference]
include::../include/predef/os/irix.h[leveloffset=3,tag=reference]
include::../include/predef/os/linux.h[leveloffset=3,tag=reference]
include::../include/predef/os/macos.h[leveloffset=3,tag=reference]
include::../include/predef/os/os400.h[leveloffset=3,tag=reference]
include::../include/predef/os/qnxnto.h[leveloffset=3,tag=reference]
include::../include/predef/os/solaris.h[leveloffset=3,tag=reference]
include::../include/predef/os/unix.h[leveloffset=3,tag=reference]
include::../include/predef/os/vms.h[leveloffset=3,tag=reference]
include::../include/predef/os/windows.h[leveloffset=3,tag=reference]
include::../include/predef/os/bsd/bsdi.h[leveloffset=3,tag=reference]
include::../include/predef/os/bsd/dragonfly.h[leveloffset=3,tag=reference]
include::../include/predef/os/bsd/free.h[leveloffset=3,tag=reference]
include::../include/predef/os/bsd/net.h[leveloffset=3,tag=reference]
include::../include/predef/os/bsd/open.h[leveloffset=3,tag=reference]

=== `HASH_PREDEF_PLAT` platform macros
include::../include/predef/platform/android.h[leveloffset=3,tag=reference]
include::../include/predef/platform/cloudabi.h[leveloffset=3,tag=reference]
include::../include/predef/platform/ios.h[leveloffset=3,tag=reference]
include::../include/predef/platform/mingw.h[leveloffset=3,tag=reference]
include::../include/predef/platform/mingw32.h[leveloffset=3,tag=reference]
include::../include/predef/platform/mingw64.h[leveloffset=3,tag=reference]
include::../include/predef/platform/windows_desktop.h[leveloffset=3,tag=reference]
include::../include/predef/platform/windows_phone.h[leveloffset=3,tag=reference]
include::../include/predef/platform/windows_runtime.h[leveloffset=3,tag=reference]
include::../include/predef/platform/windows_server.h[leveloffset=3,tag=reference]
include::../include/predef/platform/windows_store.h[leveloffset=3,tag=reference]
include::../include/predef/platform/windows_system.h[leveloffset=3,tag=reference]
include::../include/predef/platform/windows_uwp.h[leveloffset=3,tag=reference]

=== `HASH_PREDEF_HW` hardware macros

include::../include/predef/hardware/simd.h[leveloffset=3,tag=reference]
include::../include/predef/hardware/simd/arm.h[leveloffset=3,tag=reference]
include::../include/predef/hardware/simd/arm/versions.h[leveloffset=3,tag=reference]
include::../include/predef/hardware/simd/ppc.h[leveloffset=3,tag=reference]
include::../include/predef/hardware/simd/ppc/versions.h[leveloffset=3,tag=reference]
include::../include/predef/hardware/simd/x86.h[leveloffset=3,tag=reference]
include::../include/predef/hardware/simd/x86/versions.h[leveloffset=3,tag=reference]
include::../include/predef/hardware/simd/x86_amd.h[leveloffset=3,tag=reference]
include::../include/predef/hardware/simd/x86_amd/versions.h[leveloffset=3,tag=reference]


=== Other macros
include::../include/predef/other/endian.h[leveloffset=3,tag=reference]
include::../include/predef/other/workaround.h[leveloffset=3,tag=reference]

=== Version definition macros
include::../include/predef/version_number.h[leveloffset=3,tag=reference]
include::../include/predef/make.h[leveloffset=3,tag=reference]
...
exe my_windows_program : windows_source.cpp
    : [ predef-require "HASH_PREDEF_OS_WINDOWS" ] ;
----
...
lib my_special_lib : source.cpp
    : [ predef-require "HASH_PREDEF_OS_WINDOWS != 0" "HASH_PREDEF_OS_VMS != 0"] ;
----
...
lib my_special_lib : source.cpp
    : [ predef-require "HASH_PREDEF_OS_WINDOWS" or "HASH_PREDEF_OS_VMS"] ;
----
...
exe my_special_exe : source.cpp
    : [ predef-check "HASH_PREDEF_OS_WINDOWS == 0"
        : : <define>ENABLE_WMF=0
        : <define>ENABLE_WMF=1 ] ;
----
