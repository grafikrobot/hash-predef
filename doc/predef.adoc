...
include::../include/predef/library/c/_prefix.h[tag=reference]
...
include::../include/predef/library/std/_prefix.h[tag=reference]
...
include::../include/predef/os/android.h[tag=reference]
