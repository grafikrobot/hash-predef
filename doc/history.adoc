...
* Fix version calculation for LLVM `libc++` to support the changed format of
  LLVM versions 16 and above.

== 1.17.0

* Fix warnings at high levels current {CPP} compilers / standards.
