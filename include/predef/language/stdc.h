...
http://en.wikipedia.org/wiki/C_(programming_language)[Standard C] language. If
available, the year of the standard is detected as YYYY.MM.1 from the Epoch
date.
...
#				define HASH_PREDEF_LANG_STDC \
					HASH_PREDEF_MAKE_YYYYMM(__STDC_VERSION__)
#			else
#				define HASH_PREDEF_LANG_STDC \
