...
`HASH_PREDEF_PLAT_WINDOWS_*`definitions instead.
...
#	define HASH_PREDEF_PLAT_WINDOWS_RUNTIME \
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_PLAT_WINDOWS_RUNTIME, HASH_PREDEF_PLAT_WINDOWS_RUNTIME_NAME)
