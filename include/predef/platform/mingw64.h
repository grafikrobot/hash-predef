...
#		define HASH_PREDEF_PLAT_MINGW64_DETECTION \
			HASH_PREDEF_VERSION_NUMBER( \
				__MINGW64_VERSION_MAJOR, __MINGW64_VERSION_MINOR, 0)
#	endif
#	if !defined(HASH_PREDEF_PLAT_MINGW64_DETECTION)
#		define HASH_PREDEF_PLAT_MINGW64_DETECTION \
...
#		define HASH_PREDEF_PLAT_MINGW64_EMULATED \
			HASH_PREDEF_PLAT_MINGW64_DETECTION
#	else
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_PLAT_MINGW64_EMULATED, HASH_PREDEF_PLAT_MINGW64_NAME)
#endif
