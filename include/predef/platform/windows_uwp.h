...
http://docs.microsoft.com/windows/uwp/[Universal Windows Platform] is available
if the current development environment is capable of targeting UWP development.
...
#	define HASH_PREDEF_PLAT_WINDOWS_UWP \
		HASH_PREDEF_VERSION_NUMBER_NOT_AVAILABLE
#	define HASH_PREDEF_PLAT_WINDOWS_SDK_VERSION \
		HASH_PREDEF_VERSION_NUMBER_NOT_AVAILABLE
...
#			define HASH_PREDEF_PLAT_WINDOWS_SDK_VERSION \
				HASH_PREDEF_VERSION_NUMBER(0, 0, VER_PRODUCTBUILD)
#		endif

//9200 is Windows SDK 8.0 from ntverp.h which introduced family support
#		if ((HASH_PREDEF_PLAT_WINDOWS_SDK_VERSION \
				 >= HASH_PREDEF_VERSION_NUMBER(0, 0, 9200)) \
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_PLAT_WINDOWS_UWP, HASH_PREDEF_PLAT_WINDOWS_UWP_NAME)
