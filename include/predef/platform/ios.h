...
#	define HASH_PREDEF_PLAT_IOS_SIMULATOR \
...
#			define HASH_PREDEF_PLAT_IOS_DEVICE \
				HASH_PREDEF_VERSION_NUMBER_AVAILABLE
#		endif
#	endif
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_PLAT_IOS_SIMULATOR, HASH_PREDEF_PLAT_IOS_SIMULATOR_NAME)
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_PLAT_IOS_DEVICE, HASH_PREDEF_PLAT_IOS_DEVICE_NAME)
