...
#		define HASH_PREDEF_PLAT_MINGW32_DETECTION \
			HASH_PREDEF_VERSION_NUMBER( \
				__MINGW32_VERSION_MAJOR, __MINGW32_VERSION_MINOR, 0)
#	endif
#	if !defined(HASH_PREDEF_PLAT_MINGW32_DETECTION)
#		define HASH_PREDEF_PLAT_MINGW32_DETECTION \
...
#		define HASH_PREDEF_PLAT_MINGW32_EMULATED \
			HASH_PREDEF_PLAT_MINGW32_DETECTION
#	else
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_PLAT_MINGW32_EMULATED, HASH_PREDEF_PLAT_MINGW32_NAME)
#endif
