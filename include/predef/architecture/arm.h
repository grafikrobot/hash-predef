...
#			define HASH_PREDEF_ARCH_ARM \
				HASH_PREDEF_VERSION_NUMBER(__ARM_ARCH, 0, 0)
#		endif
#		if !defined(HASH_PREDEF_ARCH_ARM) && defined(__TARGET_ARCH_ARM)
#			define HASH_PREDEF_ARCH_ARM \
				HASH_PREDEF_VERSION_NUMBER(__TARGET_ARCH_ARM, 0, 0)
#		endif
#		if !defined(HASH_PREDEF_ARCH_ARM) && defined(__TARGET_ARCH_THUMB)
#			define HASH_PREDEF_ARCH_ARM \
				HASH_PREDEF_VERSION_NUMBER(__TARGET_ARCH_THUMB, 0, 0)
#		endif
#		if !defined(HASH_PREDEF_ARCH_ARM) && defined(_M_ARM)
#			define HASH_PREDEF_ARCH_ARM \
				HASH_PREDEF_VERSION_NUMBER(_M_ARM, 0, 0)
#		endif
