...
/* tag::reference[]
= `HASH_PREDEF_HW_SIMD_X86_*_VERSION`
...
/* tag::reference[]
= `HASH_PREDEF_HW_SIMD_X86_SSE_VERSION`
...
/* tag::reference[]
= `HASH_PREDEF_HW_SIMD_X86_SSE2_VERSION`
...
/* tag::reference[]
= `HASH_PREDEF_HW_SIMD_X86_SSE3_VERSION`
...
/* tag::reference[]
= `HASH_PREDEF_HW_SIMD_X86_SSSE3_VERSION`
...
/* tag::reference[]
= `HASH_PREDEF_HW_SIMD_X86_FMA3_VERSION`
...
/* tag::reference[]
= `HASH_PREDEF_HW_SIMD_X86_MIC_VERSION`
