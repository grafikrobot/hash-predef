...
#ifndef HASH_PREDEF_HARDWARE_SIMD_X86_VERSIONS_H
#define HASH_PREDEF_HARDWARE_SIMD_X86_VERSIONS_H
...
/*`
 [heading `HASH_PREDEF_HW_SIMD_X86_MMX_VERSION`]
 ...
 */
#define HASH_PREDEF_HW_SIMD_X86_MMX_VERSION HASH_PREDEF_VERSION_NUMBER(0, 99, 0)

/*`
 [heading `HASH_PREDEF_HW_SIMD_X86_SSE_VERSION`]
 ...
 */
#define HASH_PREDEF_HW_SIMD_X86_SSE_VERSION HASH_PREDEF_VERSION_NUMBER(1, 0, 0)

/*`
 [heading `HASH_PREDEF_HW_SIMD_X86_SSE2_VERSION`]

 The [@https://en.wikipedia.org/wiki/SSE2 SSE2] x86 extension version number.

 Version number is: *2.0.0*.
 */
#define HASH_PREDEF_HW_SIMD_X86_SSE2_VERSION HASH_PREDEF_VERSION_NUMBER(2, 0, 0)

/*`
 [heading `HASH_PREDEF_HW_SIMD_X86_SSE3_VERSION`]

 The [@https://en.wikipedia.org/wiki/SSE3 SSE3] x86 extension version number.

 Version number is: *3.0.0*.
 */
#define HASH_PREDEF_HW_SIMD_X86_SSE3_VERSION HASH_PREDEF_VERSION_NUMBER(3, 0, 0)

/*`
 [heading `HASH_PREDEF_HW_SIMD_X86_SSSE3_VERSION`]
...
/*`
 [heading `HASH_PREDEF_HW_SIMD_X86_SSE4_1_VERSION`]
...
/*`
 [heading `HASH_PREDEF_HW_SIMD_X86_SSE4_2_VERSION`]
...
/*`
 [heading `HASH_PREDEF_HW_SIMD_X86_AVX_VERSION`]
 ...
 */
#define HASH_PREDEF_HW_SIMD_X86_AVX_VERSION HASH_PREDEF_VERSION_NUMBER(5, 0, 0)

/*`
 [heading `HASH_PREDEF_HW_SIMD_X86_FMA3_VERSION`]
 ...
 */
#define HASH_PREDEF_HW_SIMD_X86_FMA3_VERSION HASH_PREDEF_VERSION_NUMBER(5, 2, 0)

/*`
 [heading `HASH_PREDEF_HW_SIMD_X86_AVX2_VERSION`]
 ...
 */
#define HASH_PREDEF_HW_SIMD_X86_AVX2_VERSION HASH_PREDEF_VERSION_NUMBER(5, 3, 0)

/*`
 [heading `HASH_PREDEF_HW_SIMD_X86_MIC_VERSION`]
 ...
 */
#define HASH_PREDEF_HW_SIMD_X86_MIC_VERSION HASH_PREDEF_VERSION_NUMBER(9, 0, 0)
