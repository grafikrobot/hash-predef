...
- `HASH_PREDEF_ARCH_WORD_BITS`, gives the number of word size bits (16, 32, 64).
- `HASH_PREDEF_ARCH_WORD_BITS_16`, `HASH_PREDEF_ARCH_WORD_BITS_32`, and
`HASH_PREDEF_ARCH_WORD_BITS_64`, indicate when the given word size is detected.
...
#		define HASH_PREDEF_ARCH_WORD_BITS_16 \
			HASH_PREDEF_VERSION_NUMBER_NOT_AVAILABLE
#	elif !defined(HASH_PREDEF_ARCH_WORD_BITS)
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_ARCH_WORD_BITS, HASH_PREDEF_ARCH_WORD_BITS_NAME)

#include <predef/detail/test.h>
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_ARCH_WORD_BITS_16, HASH_PREDEF_ARCH_WORD_BITS_16_NAME)

#include <predef/detail/test.h>
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_ARCH_WORD_BITS_32, HASH_PREDEF_ARCH_WORD_BITS_32_NAME)

#include <predef/detail/test.h>
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_ARCH_WORD_BITS_64, HASH_PREDEF_ARCH_WORD_BITS_64_NAME)
