...
#	if !defined(HASH_PREDEF_COMP_INTEL_DETECTION) \
		&& defined(__INTEL_COMPILER) && (__INTEL_COMPILER == 9999)
#		define HASH_PREDEF_COMP_INTEL_DETECTION \
			HASH_PREDEF_VERSION_NUMBER(12, 1, 0)
#	endif
#	if !defined(HASH_PREDEF_COMP_INTEL_DETECTION) \
		&& defined(__INTEL_COMPILER) && defined(__INTEL_COMPILER_UPDATE)
#		define HASH_PREDEF_COMP_INTEL_DETECTION \
			HASH_PREDEF_VERSION_NUMBER( \
				HASH_PREDEF_VERSION_NUMBER_MAJOR( \
					HASH_PREDEF_MAKE_10_VVRR(__INTEL_COMPILER)), \
				HASH_PREDEF_VERSION_NUMBER_MINOR( \
					HASH_PREDEF_MAKE_10_VVRR(__INTEL_COMPILER)), \
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_COMP_INTEL_EMULATED, HASH_PREDEF_COMP_INTEL_NAME)
#endif
