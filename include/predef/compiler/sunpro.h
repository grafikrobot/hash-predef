...
#			define HASH_PREDEF_COMP_SUNPRO_DETECTION \
				HASH_PREDEF_MAKE_0X_VRP(__SUNPRO_CC)
#		else
#			define HASH_PREDEF_COMP_SUNPRO_DETECTION \
				HASH_PREDEF_MAKE_0X_VVRRP(__SUNPRO_CC)
#		endif
#	endif
#	if !defined(HASH_PREDEF_COMP_SUNPRO_DETECTION) && defined(__SUNPRO_C)
#		if (__SUNPRO_C < 0x5100)
#			define HASH_PREDEF_COMP_SUNPRO_DETECTION \
				HASH_PREDEF_MAKE_0X_VRP(__SUNPRO_C)
#		else
#			define HASH_PREDEF_COMP_SUNPRO_DETECTION \
				HASH_PREDEF_MAKE_0X_VVRRP(__SUNPRO_C)
#		endif
#	endif
...
#		define HASH_PREDEF_COMP_SUNPRO_EMULATED \
			HASH_PREDEF_COMP_SUNPRO_DETECTION
#	else
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_COMP_SUNPRO_EMULATED, HASH_PREDEF_COMP_SUNPRO_NAME)
#endif
