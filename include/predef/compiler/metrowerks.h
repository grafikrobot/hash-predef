...
#		define HASH_PREDEF_COMP_MWERKS_EMULATED \
			HASH_PREDEF_COMP_MWERKS_DETECTION
#	else
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_COMP_MWERKS_EMULATED, HASH_PREDEF_COMP_MWERKS_NAME)
#endif
