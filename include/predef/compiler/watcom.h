...
#	define HASH_PREDEF_COMP_WATCOM_DETECTION \
		HASH_PREDEF_MAKE_10_VVRR(__WATCOMC__)
#endif

#ifdef HASH_PREDEF_COMP_WATCOM_DETECTION
#	if defined(HASH_PREDEF_DETAIL_COMP_DETECTED)
#		define HASH_PREDEF_COMP_WATCOM_EMULATED \
			HASH_PREDEF_COMP_WATCOM_DETECTION
#	else
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_COMP_WATCOM_EMULATED, HASH_PREDEF_COMP_WATCOM_NAME)
#endif
