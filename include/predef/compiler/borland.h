...
#		define HASH_PREDEF_COMP_BORLAND_DETECTION \
			HASH_PREDEF_MAKE_0X_VVRP(__CODEGEARC__)
#	endif
#	if !defined(HASH_PREDEF_COMP_BORLAND_DETECTION)
#		define HASH_PREDEF_COMP_BORLAND_DETECTION \
			HASH_PREDEF_MAKE_0X_VVRP(__BORLANDC__)
#	endif
#endif
...
#		define HASH_PREDEF_COMP_BORLAND_EMULATED \
			HASH_PREDEF_COMP_BORLAND_DETECTION
#	else
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_COMP_BORLAND_EMULATED, HASH_PREDEF_COMP_BORLAND_NAME)
#endif
