...
#define HASH_PREDEF_INTERNAL_GENERATE_TESTS

void * add_predef_entry(
	const char * name, const char * description, unsigned value);
#undef HASH_PREDEF_DECLARE_TEST
#define HASH_PREDEF_DECLARE_TEST(x, s) \
	void predef_entry_##x() { add_predef_entry(#x, s, x); }
#include <predef.h>

#undef HASH_PREDEF_DECLARE_TEST
#define HASH_PREDEF_DECLARE_TEST(x, s) predef_entry_##x();
