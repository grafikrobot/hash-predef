...
individually. This detects the following variations and sets a specific version
number macro to match:

- `HASH_PREDEF_OS_BSD_DRAGONFLY`
http://en.wikipedia.org/wiki/DragonFly_BSD[DragonFly BSD]
