...
#	define HASH_PREDEF_OS_BSD_DRAGONFLY \
		HASH_PREDEF_VERSION_NUMBER_NOT_AVAILABLE

#	if !defined(HASH_PREDEF_DETAIL_OS_DETECTED) && (defined(__DragonFly__))
...
#			define HASH_PREDEF_OS_DRAGONFLY_BSD \
...
HASH_PREDEF_DECLARE_TEST(
	HASH_PREDEF_OS_BSD_DRAGONFLY, HASH_PREDEF_OS_BSD_DRAGONFLY_NAME)
